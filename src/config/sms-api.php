...
return [
    ...
    'default' => env('SMS_API_DEFAULT_GATEWAY', 'SMSNOT'), //Choose default gateway
    
//    Basic Gateway Sample Configuration
'SMSNOT' => [
    'method' => 'GET', //Choose Request Method (GET/POST) Default:GET
    'url' => 'http://198.24.149.4/API/pushsms.aspx?', //Base URL
    'params' => [
...
//        ],
        /** Learn more about wrapper here: https://github.com/spiderhit/smsapi#wrapper-parameter **/
